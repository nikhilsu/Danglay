$(document).ready(function(){
    $('#addLocality').click(function(){
        $('div#localitySelections').append('<div class="localityForm">' + $('div.localityForm').html() + '<a href="javascript:;"><span class="glyphicon glyphicon-minus-sign" id="removeNewLocality" style="color: #990000"></span></a>' + '</div>');
